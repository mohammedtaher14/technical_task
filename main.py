...
df = pd.read_csv('/home/mohamed/jupyter_nb/my_project_env/wuzzf.csv')
...
with open('/home/mohamed/jupyter_nb/my_project_env/tones.json') as json_file:
...
@app.route('/ES/<string:name>', methods=['GET'])
def Hotel_indexer2(name):
  ...
  #  for i in hotel_names:
   #     res.append(es.get(index='megacorp',doc_type='hotel',id=i))
    ...
    return jsonify(es.get(index='megacorp',doc_type='hotel',id=name))    
